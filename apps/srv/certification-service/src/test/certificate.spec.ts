...
describe('Certificats', () => {
    ...
    it('A.1 should create new certificates', async (done) => {
    ...
    it('A.2 should get a list of all certificates', async (done) => {
        const res = await request(server).get('/certificate').expect(HttpStatus.OK);
    ...
    it('A.3 should get a specific certificate', async (done) => {
    ...
    it('A.4 should delete a specific certificate', async (done) => {
        let res = await request(server).get('/certificate').expect(HttpStatus.OK);
